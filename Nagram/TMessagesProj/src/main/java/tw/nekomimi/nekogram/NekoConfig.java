...
//    public static ConfigItem useIPv6 = addConfig("IPv6", configTypeBool, false);
    ...
    public static ConfigItem hideKeyboardOnChatScroll = addConfig("HideKeyboardOnChatScroll", configTypeBool, true);
...
//    public static ConfigItem disableProxyWhenVpnEnabled = addConfig("DisableProxyWhenVpnEnabled", configTypeBool, false);
    public static final ConfigItem skipOpenLinkConfirm = fixedBoolConfig("SkipOpenLinkConfirm", true);
...
//    public static ConfigItem useDefaultTheme = addConfig("UseDefaultTheme", configTypeBool, false);
    ...
    public static ConfigItem confirmAVMessage = addConfig("ConfirmAVMessage", configTypeBool, true);
    ...
    // Clean build: compatibility value for widespread haptic call sites; not a setting.
    public static final ConfigItem disableVibration = fixedBoolConfig("DisableVibration", false);
...
//    public static ConfigItem disableTrending = addConfig("DisableTrending", configTypeBool, true);
    public static final ConfigItem dontSendGreetingSticker = fixedBoolConfig("DontSendGreetingSticker", true);
    public static final ConfigItem disableSwipeToNext = fixedBoolConfig("disableSwipeToNextChannel", true);
    public static final ConfigItem disableRemoteEmojiInteractions = fixedBoolConfig("disableRemoteEmojiInteractions", true);
    ...
    public static final ConfigItem disablePremiumStickerAnimation = fixedBoolConfig("disablePremiumStickerAnimation", true);
    public static final ConfigItem hideSponsoredMessage = fixedBoolConfig("hideSponsoredMessage", true);
    public static boolean showSpoilersDirectly() {
        return false;
    }
    ...
    // priv branch changes
    public static final ConfigItem localPremium = fixedBoolConfig("localPremium", false);
    ...
    private static ConfigItem fixedBoolConfig(String key, boolean value) {
        ConfigItem item = new ConfigItem(key, configTypeBool, value);
        item.value = value;
        return item;
    }
